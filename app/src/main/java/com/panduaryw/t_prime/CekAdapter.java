...
public class CekAdapter extends RecyclerView.Adapter<CekAdapter.ViewHolder>  {
    Context context; //inisiasi variable
    List<PembayaranModel> pembayaranList; //

    public CekAdapter(Context context, List<PembayaranModel> TempList) {
    ...
    @Override
    public CekAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(CekAdapter.ViewHolder holder, int position) {
